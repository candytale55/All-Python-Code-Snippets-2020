# Create a new list named greater_than that contains True or False depending 
# on whether the corresponding item in list a is greater than the one in list b. 
